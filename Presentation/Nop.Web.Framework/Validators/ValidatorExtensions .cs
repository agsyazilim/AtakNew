...
namespace Nop.Web.Framework.Validators
{
    ...
    public static class ValidatorExtensions
    {
        ...
        public static IRuleBuilderOptions<T, string> IsIdentityNumber<T>(this IRuleBuilder<T, string> ruleBuilder)
        {
            return ruleBuilder.SetValidator(new IdentityNumberValidator());
        }
    }
}
