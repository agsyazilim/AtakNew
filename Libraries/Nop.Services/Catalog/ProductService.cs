...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public List<Product> GetUsdProducts()
        {
            var data = _productRepository.Table.Where(x => x.ProductCost > 0).ToList();
            return data;
        }

        public void UpdateSku()
        {
            //_productRepository.RunSql("Update Product Set Sku = Id");
        }
